    ...
    <div className="fixed inset-0 z-[100] overflow-hidden">
      ...
      <div className="fixed inset-y-0 right-0 max-w-full flex pl-10">
        <div className="w-screen max-w-md bg-[#FAF8F5] dark:bg-[#0E1A1C] border-l border-[#C5A880]/30 shadow-2xl flex flex-col text-[#2C221E] dark:text-[#F2EFE9] transition-colors">
          ...
          {cart.length > 0 && (
            <div className="p-6 border-t border-stone-200 dark:border-stone-800 bg-white/70 dark:bg-stone-900/80 backdrop-blur-sm space-y-4">
              ...
              <form onSubmit={handleApplyCoupon} className="space-y-1.5">
                ...
                {appliedCoupon && (
                  <div className="flex items-center justify-between text-[11px] text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/40 px-2.5 py-1 rounded">
                ...
                {couponFeedback && !appliedCoupon && (
                  <p className="text-[11px] text-rose-500">{couponFeedback.text}</p>
                )}
              </form>

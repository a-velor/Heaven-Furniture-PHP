...
export const BrandIntro: React.FC<BrandIntroProps> = ({ onOpenQuote }) => {
  return (
    <section className="py-20 lg:py-28 bg-[#132629] dark:bg-[#071011] text-[#FAF8F5] relative overflow-hidden transition-colors duration-300">

...
export const BeforeAfterSlider = ({
  ...
  return <div className={`relative select-none flex flex-col ${className}`}>
      {
    /* Visual Slider Stage */
  }
      <div
  ...
  />
    ...
    /* Floating Label: Before (Left) */
        ...
        <div
    className={`absolute top-4 left-4 z-20 transition-opacity duration-300 pointer-events-none ${sliderPosition < 15 ? "opacity-0" : "opacity-100"}`}
  >
    ...
    /* Floating Label: After (Right) */
        ...
        <div
    className={`absolute top-4 right-4 z-20 transition-opacity duration-300 pointer-events-none ${sliderPosition > 85 ? "opacity-0" : "opacity-100"}`}
  >
  ...
  >
    ...
    /* Central Handle Knob */
          ...
          <div
    className={`absolute w-10 h-10 rounded-full bg-[#132629] border-2 border-[#C5A880] shadow-[0_4px_16px_rgba(0,0,0,0.6)] flex items-center justify-center transition-transform duration-150 ${isDragging ? "scale-110 ring-4 ring-[#C5A880]/30" : "group-hover:scale-105"}`}
  >
    ...
    className={`px-3 py-1.5 rounded-sm border transition-colors ${sliderPosition === 0 ? "bg-[#132629] text-[#FAF8F5] border-[#C5A880]" : "border-stone-300 dark:border-stone-700 text-stone-600 dark:text-stone-300 hover:border-[#C5A880]"}`}
  >
          Show Before (100%)
        </button>
    ...
    className={`px-3 py-1.5 rounded-sm border transition-colors font-medium ${sliderPosition === 50 ? "bg-[#C5A880] text-[#132629] border-[#C5A880]" : "border-stone-300 dark:border-stone-700 text-stone-600 dark:text-stone-300 hover:border-[#C5A880]"}`}
  >
          Split 50 / 50
        </button>
    ...
    className={`px-3 py-1.5 rounded-sm border transition-colors ${sliderPosition === 100 ? "bg-[#132629] text-[#FAF8F5] border-[#C5A880]" : "border-stone-300 dark:border-stone-700 text-stone-600 dark:text-stone-300 hover:border-[#C5A880]"}`}
  >
          Show After (100%)
        </button>
      </div>

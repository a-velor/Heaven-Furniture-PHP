...
export const CheckoutModal: React.FC = () => {
  ...
  const [shippingMethod, setShippingMethod] = useState<'white-glove' | 'freight' | 'pickup'>('white-glove');
  const [paymentMethod, setPaymentMethod] = useState<'bkash' | 'nagad' | 'card' | 'cod' | 'bank_transfer'>('bkash');
        ...
        <div className="relative w-full max-w-3xl bg-[#FAF8F5] dark:bg-[#0E1A1C] rounded-xl shadow-2xl border border-[#C5A880]/40 text-[#2C221E] dark:text-[#F2EFE9] overflow-hidden transition-colors my-6">
          ...
          <form onSubmit={handleSubmit} className="p-6 sm:p-8 space-y-6">
                ...
                <label
                  ...
                  className={`p-3 rounded-lg border cursor-pointer transition-all flex flex-col justify-between ${
                    shippingMethod === 'white-glove'
                      ? 'border-[#8C6239] dark:border-[#C5A880] bg-[#8C6239]/10 ring-1 ring-[#C5A880]'
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 text-xs">
                ...
                <button
                  ...
                  className={`p-3 rounded border text-left flex flex-col justify-between transition-all ${
                    paymentMethod === 'bkash'
                      ? 'border-pink-600 bg-pink-50/50 dark:bg-pink-950/30 text-pink-900 dark:text-pink-100 font-semibold ring-1 ring-pink-500'
                ...
                <button
                  ...
                  className={`p-3 rounded border text-left flex flex-col justify-between transition-all ${
                    paymentMethod === 'nagad'
                      ? 'border-orange-600 bg-orange-50/50 dark:bg-orange-950/30 text-orange-900 dark:text-orange-100 font-semibold ring-1 ring-orange-500'
                      : 'border-stone-300 dark:border-stone-700'
                  }`}
                >
                  <div className="flex items-center gap-1.5">
                ...
                <button
                  ...
                  className={`p-3 rounded border text-left flex flex-col justify-between transition-all ${
                    paymentMethod === 'card'
                      ? 'border-[#8C6239] dark:border-[#C5A880] bg-[#8C6239]/10 font-semibold ring-1 ring-[#C5A880]'
                      : 'border-stone-300 dark:border-stone-700'
                  }`}
                >
                  <div className="flex items-center gap-1.5">
              ...
              {/* Payment Details Box */}
              {paymentMethod === 'bkash' && (
                <div className="p-3 bg-pink-50/70 dark:bg-pink-950/20 border border-pink-200 dark:border-pink-900 rounded text-xs space-y-1.5">
              ...
              {paymentMethod === 'bank_transfer' && (
                <div className="p-3 bg-stone-100 dark:bg-stone-900 border border-stone-200 dark:border-stone-800 rounded text-xs space-y-1 text-stone-700 dark:text-stone-300">
            ...
            <div className="p-4 bg-stone-100/70 dark:bg-stone-950/60 rounded-lg border border-stone-200 dark:border-stone-800 space-y-3">
              ...
              <div className="max-h-36 overflow-y-auto divide-y divide-stone-200 dark:divide-stone-800 text-xs">
                {cart.map((item) => (
                  <div key={item.cartId} className="py-2 flex items-center justify-between gap-3">
            ...
            <div className="space-y-4">
              ...
              >
                {isSubmitting ? (
                  <span>Transmitting Commission to Atelier...</span>
                ) : (
                  <>

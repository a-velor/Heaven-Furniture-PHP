...
export const ShopCatalog: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FAF8F5] dark:bg-[#0B1617] text-[#2C221E] dark:text-[#F2EFE9] transition-colors py-10 px-4 sm:px-6 lg:px-12">
      <div className="max-w-7xl mx-auto space-y-8">
              ...
              <button
                ...
                className={`px-3.5 py-1.5 rounded-full whitespace-nowrap transition-all ${
                  selectedCategory === cat.id
                    ? 'bg-[#132629] dark:bg-[#C5A880] text-white dark:text-[#0B1617] font-semibold shadow-xs'
        ...
        <div className="flex items-center justify-between text-xs text-stone-500">
          ...
          {(searchQuery || selectedCategory !== 'all' || selectedWood !== 'all' || onlyInStock) && (
            <button
              onClick={() => {
                setSearchQuery('');
        ...
        {filteredProducts.length === 0 ? (
          <div className="text-center py-20 bg-white/50 dark:bg-stone-900/30 rounded-2xl border border-dashed border-stone-300 dark:border-stone-800">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {filteredProducts.map((item: FurnitureItem) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="relative aspect-4/3 overflow-hidden bg-stone-100 dark:bg-stone-950">
                    ...
                    {/* Tag Badge */}
                    {item.highlightTag && (
                      <span className="absolute top-3 left-3 px-2.5 py-0.5 bg-[#132629]/90 dark:bg-[#C5A880]/90 text-white dark:text-[#0B1617] text-[10px] font-bold tracking-widest uppercase rounded">
                        {item.highlightTag}
                      </span>
                    )}
